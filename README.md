...
- **Playwright 使用指南**：[opencode-config/opencode/docs/playwright-setup.md](opencode-config/opencode/docs/playwright-setup.md) — 通过 SSH 反向隧道让容器内的 AI 驱动你本机的真实浏览器（CDP），复用本机 IP 与登录态。
